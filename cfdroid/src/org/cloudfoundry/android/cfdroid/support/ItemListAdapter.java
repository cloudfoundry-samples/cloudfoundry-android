 ...
 *
 * @param <I> the kind of domain object this adapter deals with
 * @param <V> the type that represents an item's view
 */
public abstract class ItemListAdapter<I, V> extends
        BaseAdapter {
